...
3. **Use Sub-Issues API for relationships** — `addSubIssue` mutation with `GraphQL-Features: sub_issues` header
4. **Relationships are immediate** — no parsing delays with sub-issues API
